...
SUPPORT_MATRIX: tuple[SupportEntry, ...] = (
    ...
    SupportEntry(
        ...
        op_type="Concat",
        opset_range="11+",
        schema_form="static same-quantization int8 tensors, explicit axis",
        lowering="planned_cmsis_concatenation_s8",
        backend="reject",
        capability_type="import_boundary",
        status="blocked",
        planned=True,
        notes="Planned SqueezeNet-derived minimum case; not a current claimed PASS row.",
    ),
    SupportEntry(
