...
RUNTIME_ACTIONS = {
    ...
    "And": ("direct_api", "generated_c_and_bool", False),
    "ArgMax": ("direct_api", "generated_c_argmax_index", False),
    "ArgMin": ("direct_api", "generated_c_argmin_index", False),
    "AveragePool": ("direct_api", "arm_avgpool_s8", True),
    "Ceil": ("direct_api", "generated_c_ceil_s8", False),
    "Celu": ("direct_api", "generated_c_celu_s8", False),
    ...
    "Elu": ("direct_api", "generated_c_elu_s8", False),
    "Equal": ("direct_api", "generated_c_equal_bool", False),
    "Erf": ("direct_api", "generated_c_erf_s8", False),
    ...
    "GlobalLpPool": ("direct_api", "generated_c_globallppool_s8", False),
    "GlobalMaxPool": ("direct_api", "generated_c_globalmaxpool_s8", False),
    "Greater": ("direct_api", "generated_c_greater_bool", False),
    "GreaterOrEqual": ("direct_api", "generated_c_greaterorequal_bool", False),
    "HardSigmoid": ("direct_api", "generated_c_hardsigmoid_s8", False),
    "HardSwish": ("direct_api", "generated_c_hardswish_s8", False),
    "LeakyRelu": ("direct_api", "generated_c_leakyrelu_s8", False),
    "Less": ("direct_api", "generated_c_less_bool", False),
    "LessOrEqual": ("direct_api", "generated_c_lessorequal_bool", False),
    "Log": ("direct_api", "generated_c_log_s8", False),
    "LpNormalization": ("direct_api", "generated_c_lpnormalization_s8", False),
    "LpPool": ("direct_api", "generated_c_lppool_s8", False),
    ...
    "Mean": ("direct_api", "generated_c_mean_s8", False),
    "Min": ("direct_api", "generated_c_min_s8", False),
    "Mul": ("direct_api", "arm_elementwise_mul_s8", True),
    "CumSum": ("direct_api", "generated_c_cumsum_s8", False),
    "Sum": ("direct_api", "generated_c_sum_s8", False),
    "Neg": ("direct_api", "generated_c_neg_s8", False),
    "Not": ("direct_api", "generated_c_not_bool", False),
    "Or": ("direct_api", "generated_c_or_bool", False),
    "Xor": ("direct_api", "generated_c_xor_bool", False),
    "PRelu": ("direct_api", "generated_c_prelu_s8", False),
    ...
    "ReduceLogSum": ("direct_api", "generated_c_reducelogsum_s8", False),
    "ReduceLogSumExp": ("direct_api", "generated_c_reducelogsumexp_s8", False),
    "ReduceProd": ("direct_api", "generated_c_reduceprod_s8", False),
    "ReduceSum": ("direct_api", "generated_c_reducesum_s8", False),
    "ReduceSumSquare": ("direct_api", "generated_c_reducesumsquare_s8", False),
    "Round": ("direct_api", "generated_c_round_s8", False),
    "Selu": ("direct_api", "generated_c_selu_s8", False),
    "Sign": ("direct_api", "generated_c_sign_s8", False),
    "Softplus": ("direct_api", "generated_c_softplus_s8", False),
    "Softsign": ("direct_api", "generated_c_softsign_s8", False),
    "ThresholdedRelu": ("direct_api", "generated_c_thresholdedrelu_s8", False),
