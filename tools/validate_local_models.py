...
from nanoc_nn.codegen.generator import generate_project  # noqa: E402
from nanoc_nn.codegen.model import CodegenOptions, GenerationResult  # noqa: E402
from nanoc_nn.converter.exporter import convert_model  # noqa: E402
from nanoc_nn.converter.model import ConversionOptions  # noqa: E402
...
def main() -> int:
    build_dir = REPO_ROOT / "build" / "local-validation"
...
def _coverage_report(rows: list[ValidationRow]) -> str:
    lines = [
        ...
        "",
        "验证链路固定为：ONNX -> `nanoc_nn.converter` 输出目录 -> "
        "`nanoc_nn.codegen`，codegen 不直接读取 ONNX。",
        "",
